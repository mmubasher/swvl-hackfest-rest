...
const options = {
    ...
    routes: {
        include: [
             '/api/faqs', '/api/network/discover', '/api/network/friends', '/api/network', '/api/notifications/follow',
             '/api/users/settings/block/list', '/api/notifications', '/api/portfolio/discover'
        ],
    },
};
